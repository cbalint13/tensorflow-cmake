...
if (systemlib_GIF)
  ...
  list(APPEND tensorflow_EXTERNAL_LIBRARIES ${GIF_LIBRARY})

  message(STATUS "  gif includes: ${GIF_INCLUDE_DIR}")
  message(STATUS "  gif libraries: ${GIF_LIBRARY}")

  add_custom_target(gif_build)
  ...
  set(gif_BUILD ${CMAKE_BINARY_DIR}/gif/src/gif_build)
  ...
  if(WIN32)
    ...
    ExternalProject_Add_Step(gif_build copy_unistd
