...
set(cub_BUILD ${CMAKE_CURRENT_BINARY_DIR}/cub/src/cub/third_party)
...
ExternalProject_Add(cub
    PREFIX cub
    SOURCE_DIR ${CMAKE_CURRENT_BINARY_DIR}/cub/src/cub/third_party
    URL ${cub_URL}
    URL_HASH ${cub_HASH}
    DOWNLOAD_DIR "${DOWNLOAD_LOCATION}"
    BUILD_IN_SOURCE 1
    PATCH_COMMAND ${CMAKE_COMMAND} -E copy_if_different ${CMAKE_CURRENT_SOURCE_DIR}/patches/cub/CMakeLists.txt ${cub_BUILD}
    INSTALL_COMMAND  ${CMAKE_COMMAND} -E copy_directory  ${cub_INCLUDE_DIR}/third_party ${cub_ARCHIVE_DIR}/cub)
