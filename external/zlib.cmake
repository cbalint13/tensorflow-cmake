...
if (systemlib_ZLIB)
  ...
  list(APPEND tensorflow_EXTERNAL_LIBRARIES ${ZLIB_LIBRARY})
  ...
  set(ZLIB_BUILD ${CMAKE_CURRENT_BINARY_DIR}/zlib/src/zlib_build)
  ...
  include_directories(${zlib_INCLUDE_DIR})
  list(APPEND tensorflow_EXTERNAL_LIBRARIES ${zlib_STATIC_LIBRARIES})
