...
if (systemlib_EIGEN3)
  ...
  add_custom_target(eigen_build)
  list(APPEND tensorflow_EXTERNAL_DEPENDENCIES eigen_build)

else (systemlib_EIGEN3)
  ...
  set(eigen_BUILD ${CMAKE_CURRENT_BINARY_DIR}/eigen/src/eigen_build)
