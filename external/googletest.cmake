...
# ==============================================================================
if (systemlib_GOOGLETEST)

  find_package(GTest REQUIRED)
  include_directories(${GTEST_INCLUDE_DIRS})
  list(APPEND tensorflow_EXTERNAL_LIBRARIES ${GTEST_LIBRARIES})

  message(STATUS "  googletest includes: ${GTEST_INCLUDE_DIRS}")
  message(STATUS "  googletest libraries: ${GTEST_LIBRARIES}")

  add_custom_target(googletest_build)
  list(APPEND tensorflow_EXTERNAL_DEPENDENCIES googletest_build)

else (systemlib_GOOGLETEST)
  ...
  list(APPEND tensorflow_EXTERNAL_LIBRARIES ${googletest_STATIC_LIBRARIES})

  list(APPEND tensorflow_EXTERNAL_DEPENDENCIES googletest_build)

endif (systemlib_GOOGLETEST)
