...
if (systemlib_LMDB)
  ...
  include_directories(${LMDB_INCLUDEDIR})
  list(APPEND tensorflow_EXTERNAL_LIBRARIES ${LMDB_LIBRARIES})
  list(APPEND ADD_LINK_DIRECTORY ${LMDB_LIBDIR})
  list(APPEND ADD_CFLAGS ${LMDB_CFLAGS_OTHER})

  message(STATUS "Found lmdb (\"${LMDB_VERSION}\") external")
  message(STATUS "  lmdb includes: ${LMDB_INCLUDEDIR}")
  message(STATUS "  lmdb libraries: ${LMDB_LIBRARIES}")

  add_custom_target(lmdb_build)
  add_custom_target(lmdb_copy_headers_to_destination)
  list(APPEND tensorflow_EXTERNAL_DEPENDENCIES lmdb_copy_headers_to_destination)
  ...
  set(lmdb_BUILD ${CMAKE_BINARY_DIR}/lmdb/src/lmdb_build)
  ...
  ExternalProject_Add(lmdb_build
      PREFIX lmdb
      URL ${lmdb_URL}
      URL_HASH ${lmdb_HASH}
  ...
  list(APPEND tensorflow_EXTERNAL_LIBRARIES ${lmdb_STATIC_LIBRARIES})
