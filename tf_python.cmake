...
function(RELATIVE_PROTOBUF_GENERATE_PYTHON ROOT_DIR SRCS)
  ...
  foreach(FIL ${ARGN})
    ...
    if(NOT EXISTS "${CMAKE_CURRENT_BINARY_DIR}/tf_python/${REL_DIR}/${FIL_WE}_pb2.py")
      add_custom_command(
        ...
        DEPENDS ${PROTOBUF_PROTOC_EXECUTABLE} protobuf_build
...
GENERATE_PYTHON_OP_LIB("experimental_dataset_ops")
...
GENERATE_PYTHON_OP_LIB("xla_ops_jit"
  DESTINATION ${CMAKE_CURRENT_BINARY_DIR}/tf_python/tensorflow/compiler/jit/ops/xla_ops_grad.py)
GENERATE_PYTHON_OP_LIB("trt_engine_op_tf2tensorrt"
  DESTINATION ${CMAKE_CURRENT_BINARY_DIR}/tf_python/tensorflow/compiler/tf2tensorrt/python/ops/trt_ops.py)
...
set (pywrap_tensorflow_internal_src
    ...
    "${tensorflow_source_dir}/tensorflow/python/client/session_ref.cc"
