...
foreach(tf_cc_op_lib_name ${tf_cc_op_lib_names})
    ...
    if(NOT EXISTS "${cc_ops_target_dir}/${tf_cc_op_lib_name}.h" OR
       NOT EXISTS "${cc_ops_target_dir}/${tf_cc_op_lib_name}.cc" OR
       NOT EXISTS "${cc_ops_target_dir}/${tf_cc_op_lib_name}_internal.h" OR
       NOT EXISTS "${cc_ops_target_dir}/${tf_cc_op_lib_name}_internal.cc")
      add_custom_command(
